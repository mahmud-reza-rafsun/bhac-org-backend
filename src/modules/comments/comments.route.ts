...
route.get("/get-all-comments", checkAuth(Role.ADMIN, Role.MEMBER), CommentController.getCommentsByIdeaId);
route.get("/get-comments/:id", checkAuth(Role.ADMIN, Role.MEMBER), CommentController.getCommentsByIdeaId);
